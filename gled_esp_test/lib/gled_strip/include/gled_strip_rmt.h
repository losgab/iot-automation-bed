...
{
    gled_strip_rmt_encoder_t *strip_encoder; // RMT Strip Encoder Handle
...
typedef struct
{
     ...
     */
    esp_err_t (*set_pixel)(gled_strip_rmt_device_t *rmt_device, uint16_t index, uint8_t red, uint8_t green, uint8_t blue);
     ...
     * @return ESP_OK on success, otherwise an error code
     */
    esp_err_t (*refresh)(gled_strip_rmt_device_t *rmt_device);
     ...
     * @return ESP_OK on success, otherwise an error code
     */
    esp_err_t (*clear)(gled_strip_rmt_device_t *rmt_device);
     ...
     * @return ESP_OK on success, otherwise an error code
     */
    esp_err_t (*del)(gled_strip_rmt_device_t *rmt_device);
